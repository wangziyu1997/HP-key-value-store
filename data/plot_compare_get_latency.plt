...
reset
set output "figure/get_latency_compare_memtier.eps"
...
plot  \
	"./compare/compare_redis.dat" u 2:10 title "Redis" w lp lt 3 lw 3 pt 7 ps 1.5 lc rgb '#FF7F00', \
	"./compare/compare_memcached.dat" u 2:10 title "Memcached" w lp lt 3 lw 3 pt 7 ps 1.5 lc rgb '#C0FF3E'