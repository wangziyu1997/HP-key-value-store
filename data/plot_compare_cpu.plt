...
reset
set output "figure/cpu_compare_memtier.eps"
...
plot  \
	"./compare/redistop.dat" u 1:($2) title "Redis" w lp lt 3 lw 3 pt 7 ps 0 lc rgb '#FF7F00', \
	"./compare/memtop.dat" u 1:($2) title "Memcached" w lp lt 3 lw 3 pt 7 ps 0 lc rgb '#C0FF3E'