...
reset
set output "figure/get_throughput_compare_memtier.eps"
...
plot  \
	"./compare/compare_redis.dat" u 2:6 title "Redis" w lp lt 3 lw 3 pt 7 ps 1.5 lc rgb '#FF7F00', \
	"./compare/compare_memcached.dat" u 2:6 title "Memcached" w lp lt 3 lw 3 pt 7 ps 1.5 lc rgb '#C0FF3E'