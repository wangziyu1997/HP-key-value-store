...
set title "growth_factor" font ",26"
set ylabel "Throughput (rsp/s)" font ",24"
set xlabel "Number of growth_factor" font ",24"
...
plot "./plot_data/growth_factor.dat" u 1:($2) title "growth_factor" w lp lt 1 lw 3 pt 2 ps 1.8 lc rgb '#ff7373'
